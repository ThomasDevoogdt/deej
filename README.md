...
This is a fork, simply to fix some imports, original repo: https://github.com/omriharel/deej/.
...
**[Download the latest release](https://github.com/ThomasDevoogdt/deej/releases/latest) | [Video demonstration](https://youtu.be/VoByJ4USMr8) | [Build video by Tech Always](https://youtu.be/x2yXbFiiAeI)**
...
deej is written in Go and [distributed](https://github.com/ThomasDevoogdt/deej/releases/latest) as a portable (no installer needed) executable.
...
> **Looking for the older Python version?** It's no longer maintained, but you can always find it in the [`legacy-python` branch](https://github.com/ThomasDevoogdt/deej/tree/legacy-python).
...
- Head over to the [releases page](https://github.com/ThomasDevoogdt/deej/releases) and download the [latest version](https://github.com/ThomasDevoogdt/deej/releases/latest)'s executable and configuration file (`deej.exe` and `config.yaml`)
...
Like other Go packages, you can also use the `go get` tool: `go get -u github.com/ThomasDevoogdt/deej/pkg/deej`. Please note that the package code now resides in the `pkg/deej` directory, and needs to be imported from there if used inside another project.
